# Generated by Django 2.2.3 on 2019-07-11 04:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('schedule', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='payment', to='course_management.Schedule')),
            ],
        ),
    ]
